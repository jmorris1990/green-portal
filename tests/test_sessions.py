...
def test_sessions(client, auth):
    ...
    print(response.data)
    assert b'<li class="session">Course 1 CSET 180 A MTWRF 12:00:00-16:30:00' in response.data
    assert b'<li class="session">Course 1 CSET 180 C MWF 12:00:00-13:00:00' not in response.data
